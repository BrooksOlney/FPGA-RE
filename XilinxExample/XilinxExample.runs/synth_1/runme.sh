...
HD_PWD='/media/brookz/Storage/Research/FPGA-RE/XilinxExample/XilinxExample.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log primitives.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source primitives.tcl

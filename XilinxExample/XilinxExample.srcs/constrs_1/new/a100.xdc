...
## Switches
# set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {op[0]}]
# set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {op[1]}]
# set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {op[2]}]
# set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {op[3]}]
...
# set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { data[0] }]; #IO_L19N_T3_VREF_35 Sch=led0_g
# set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { data[1] }]; #IO_L19P_T3_35 Sch=led0_r
# set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { data[2] }]; #IO_L20P_T3_35 Sch=led1_b
# set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { data[3] }]; #IO_L21P_T3_DQS_35 Sch=led1_g
# set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { data[4] }]; #IO_L20N_T3_35 Sch=led1_r
...
## Pmod Header JC
# set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { op[4] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
# set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { op[5] }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]

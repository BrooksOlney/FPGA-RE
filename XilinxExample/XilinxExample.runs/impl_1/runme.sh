...
HD_PWD='/media/brookz/Storage/Research/FPGA-RE/XilinxExample/XilinxExample.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log primitives.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source primitives.tcl -notrace
